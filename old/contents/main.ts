...
UTMarketSearchFiltersView.prototype.old = function _generate() {
...
UTMarketSearchFiltersView.prototype._generate = function _generate() {
	...
	const pinnedListContainer = select<HTMLElement>(".ut-pinned-list-container", this.__root);
	pinnedListContainer.style.display = "flex";
	pinnedListContainer.style.flexDirection = "column";
	pinnedListContainer.style.gap = "10px";

	const uiContent = select<HTMLElement>(".ui-content", this.__root);
	uiContent.style.flex = "1";
